# Phase Calibration
This is a Desmos project to play music in Desmos

Simply run the python file to generate the short time fourier coefficients that you can paste into the data folder of this graph: https://www.desmos.com/calculator/6zarljz1ei
